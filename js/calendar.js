...
Calendar.DEFAULT_CONFIG = {
    ...
    START_WEEKDAY : {key:"start_weekday", value:1},
    ...
    MONTHS_SHORT : {key:"months_short", value:["Янв", "Фев", "Мар", "Апр", "Май", "Июнь", "Июль", "Авг", "Сент", "Окт", "Нояб", "Дек"]},
    MONTHS_LONG: {key:"months_long", value:["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"]},
    WEEKDAYS_1CHAR: {key:"weekdays_1char", value:["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"]},
    WEEKDAYS_SHORT: {key:"weekdays_short", value:["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"]},
    WEEKDAYS_MEDIUM: {key:"weekdays_medium", value:["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"]},
    WEEKDAYS_LONG: {key:"weekdays_long", value:["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"]},
